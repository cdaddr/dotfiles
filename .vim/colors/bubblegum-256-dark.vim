...
" Original at github.com/baskerville/bubblegum
" This file has some edits made below -- brian@carper.ca
...
" Mark
hi Folded ctermfg=244 ctermbg=235 cterm=none guifg=#f08080 guibg=#181818 gui=none
hi FoldColumn ctermfg=79 ctermbg=237 cterm=none guifg=#5FD7AF guibg=#181818 gui=none
hi SignColumn ctermfg=184 ctermbg=237 cterm=none guifg=#D7D700 guibg=#181818 gui=none
hi ColorColumn ctermbg=237 cterm=none guibg=#3A3A3A gui=none
hi LineNr ctermfg=244 ctermbg=237 cterm=none guifg=#808080 guibg=#181818 gui=none
hi MatchParen ctermfg=16 ctermbg=215 cterm=none guibg=#4a4a4a gui=none
...
hi Cursor guifg=#000000 guibg=#AFD787

" Search
hi Search ctermfg=16 ctermbg=179 cterm=none guifg=#000000 guibg=#87AFD7 gui=none
hi IncSearch ctermfg=231 ctermbg=168 cterm=none guifg=#FFFFFF guibg=#87AFD7 gui=none
...
" Misc
hi SpecialKey ctermfg=114 ctermbg=235 cterm=none guifg=#505050 guibg=#262626 gui=none
hi NonText ctermfg=244 ctermbg=235 cterm=none guifg=#505050 guibg=#262626 gui=none
