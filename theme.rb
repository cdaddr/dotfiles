...
def generate_nvim_colorscheme(theme_names)
  output_file = CONFIG / 'nvim/theme.lua'
  File.write(output_file, <<~LUA)
    -- generated by theme.rb
    return { nvim = "#{theme_names['nvim']}", lualine = "#{theme_names['lualine']}" }
  LUA
  puts "- generated #{output_file}"
end
...
def main
  ...
  generate_nvim_colorscheme(theme_names)
