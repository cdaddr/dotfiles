-- eager (now): the colorscheme must paint on the first frame or you get a flash
-- of default colors, so it stays in now() rather than later(). Body unchanged;
-- stylua will re-indent it inside the function on a final formatting pass.
now(function()
