...
-- eager (now): registers the FileType/BufRead autocmds that start highlighting on
-- the first buffer. Deferring this would flash unhighlighted text on every startup.
now(function()
  vim.pack.add({
